...
export const ShimmerButton = React.forwardRef((
  ...
  return (
    <button
      ...
      className={cn(
        "group relative z-0 flex cursor-pointer items-center justify-center overflow-hidden whitespace-nowrap border border-[rgba(255,255,255,0.1)] px-6 py-3 text-white [background:var(--bg)] [border-radius:var(--radius)] dark:text-black",
