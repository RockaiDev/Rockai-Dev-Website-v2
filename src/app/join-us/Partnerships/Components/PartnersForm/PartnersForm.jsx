        ...
        <form className="space-y-6 p-4 sm:p-6 md:p-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="flex flex-col">
              ...
              text-gray-400 focus:outline-none focus:border-cyan-400">
                ...
                <option value="junior">Technology Partners</option>
                <option value="mid">Academic Partners</option>
                <option value="senior">Reseller Partners</option>
                <option value="senior">Strategic Partners</option>
              </select>
            </div>
            <div className="flex flex-col">
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              className="w-full py-8 px-3 rounded-[18px] bg-transparent border border-gray-700 text-white 
              placeholder-gray-400 focus:outline-none focus:border-cyan-400"
            />
          </div>
