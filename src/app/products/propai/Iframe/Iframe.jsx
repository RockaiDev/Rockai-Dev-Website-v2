                                ...
                                <div className="bg-slate-800/40 backdrop-blur-lg border border-slate-700/50 rounded-3xl p-8 shadow-2xl">
                                    <div className="space-y-6">
                                        <div className="flex items-center justify-between">
                                            <h1 className="lg:text-4xl text-xl font-bold text-white bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
...
<div className="bg-slate-800/40 backdrop-blur-lg border border-slate-700/50 rounded-2xl p-4 mx-6">
