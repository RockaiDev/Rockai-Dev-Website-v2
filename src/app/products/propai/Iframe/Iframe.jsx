...
export default function Iframe() {
    ...
    return (
        ...
        >
            ...
            {/* Stats Section */}
            <motion.div 
                className="bg-slate-800/40 backdrop-blur-lg border border-slate-700/50 rounded-2xl p-4 mx-4 sm:mx-6 mt-8"
                variants={itemVariants}
            >
                <div className="grid grid-cols-2 gap-3">
                    <motion.div 
                        className="bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-lg p-3"
                        whileHover={{ scale: 1.02 }}
                        transition={{ duration: 0.2 }}
                    >
                    ...
                    <motion.div 
                        className="bg-gradient-to-r from-green-500/20 to-blue-500/20 rounded-lg p-3"
                        whileHover={{ scale: 1.02 }}
                        transition={{ duration: 0.2 }}
                    >
                        <div className="flex items-center justify-between">
                    ...
                    <motion.div 
                        className="bg-gradient-to-r from-orange-500/20 to-red-500/20 rounded-lg p-3"
                        whileHover={{ scale: 1.02 }}
                        transition={{ duration: 0.2 }}
                    >
                        <div className="flex items-center justify-between">
