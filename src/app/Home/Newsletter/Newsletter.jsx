      ...
      <div className="w-full flex flex-col md:flex-row items-center justify-between gap-6 ">
        ...
        <div className="flex flex-col sm:flex-row justify-center  w-full md:w-auto items-center gap-3">
          <input
            ...
            className="flex-1 md:w-72 rounded-full  border border-gray-700 px-4 py-3 text-sm text-white placeholder-gray-400 focus:outline-none text-center md:text-left w-full md:w-auto"
          />
          <button className="sm:px-6 px-12 py-3 text-sm font-medium text-white rounded-full bg-gradient-to-r from-[#10DBDB] to-[#0047A5] shadow-lg shadow-cyan-500/30 hover:scale-105 hover:shadow-cyan-500/50 transition-all duration-300 cursor-pointer hover:-translate-y-1">
            Subscribe
          </button>
        </div>
      </div>
